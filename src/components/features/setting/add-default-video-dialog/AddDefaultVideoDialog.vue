...
import { defaultVideoUrlRules } from './defaultVideoUrlRules';
...
const formId = 'add-default-video-form';
...
const handleSubmit = async (): Promise<void> => {
  ...
  try {
    await settingStore.addBannerDefaultVideo(url.value);
    showSuccessSnackbar('Video added.');
    props.close();
  } catch (error: unknown) {
